...
if [ -f "marks.fish" ]
    ...
    git clone http://github.com/johnpena/fishmarks.git $HOME/.fishmarks
...
if grep -Fxq ". $FISHMARKS" $HOME/.config/fish/config.fish
    ...
    echo "# Load fishmarks (http://github.com/johnpena/fishmarks)" >> $HOME/.config/fish/config.fish
